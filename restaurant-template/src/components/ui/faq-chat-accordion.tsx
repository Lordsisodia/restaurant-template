          ...
          >
            <Accordion.Header>
              <Accordion.Trigger className="flex w-full items-center justify-start gap-x-4">
                <div
                  className={cn(
                    "relative flex items-center space-x-2 rounded-xl px-4 py-2.5 transition-all duration-300",
            ...
            <Accordion.Content asChild forceMount>
              ...
              >
                <div className="ml-7 mt-2 md:ml-16">
                  <div
                    className={cn(
                      "relative max-w-xs rounded-2xl bg-primary px-4 py-2.5 text-primary-foreground shadow-sm",
                      answerClassName
                    )}
                  >
                    {item.answer}
