...
describe('Hero Section Registry', () => {
  ...
  it('lists all registered variants', () => {
    ...
    expect(keys).toEqual(['primary', 'classic-center', 'gradient-words', 'logo-center', 'minimal-center', 'split-left', 'video-overlay', 'animated-text', 'typewriter', 'blur-fade', 'flip-words', 'typing-animation', 'magic-reveal', 'reveal-text', 'samsung-effect']);
  });
