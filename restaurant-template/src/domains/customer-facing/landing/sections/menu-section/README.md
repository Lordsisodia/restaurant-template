...
Scaffolded with `pnpm scaffold:section landing menu-section`. Update the generated files to match the section's data contract and UI.
...
Variants scaffolded: `signature-dishes`, `overview`.
