# Essentials Section Architecture

Scaffolded with `pnpm scaffold:section landing essentials-section`. Update the generated files to match the section's data contract and UI.
