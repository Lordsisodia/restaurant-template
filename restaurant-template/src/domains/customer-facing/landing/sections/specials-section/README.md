# Specials Section Architecture

Scaffolded with `pnpm scaffold:section landing specials-section`. Update the generated files to match the section's data contract and UI.
...
Variants scaffolded: `grid`, `slider`.
