# LoyaltyTopDiners Section Architecture

Scaffolded with `pnpm scaffold:section customer-facing/loyalty top-diners-leaderboard`. Update the generated files to match the section's data contract and UI.
