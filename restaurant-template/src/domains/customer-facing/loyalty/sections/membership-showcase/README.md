# LoyaltyMembershipShowcase Section Architecture

Scaffolded with `pnpm scaffold:section customer-facing/loyalty membership-showcase`. Update the generated files to match the section's data contract and UI.
