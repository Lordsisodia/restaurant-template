...
Scaffolded with `pnpm scaffold:section customer-facing/chat hero-section`. Update the generated files to match the section's data contract and UI.
...
Variants scaffolded: `primary`, `template-1`, `template-2`, `template-3`.
